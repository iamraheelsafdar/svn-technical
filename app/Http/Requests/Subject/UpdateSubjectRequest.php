...
class UpdateSubjectRequest extends BaseRequestForWeb
{
    /**
    ...
    public function messages(): array
    {
        return [
            ...
            'subjects.*.*.name.string' => 'Subject name must be a string.',
            'subjects.*.*.name.max' => 'Subject name cannot exceed 255 characters.',
            'subjects.*.*.code.required' => 'Subject code is required.',
            'subjects.*.*.code.string' => 'Subject code must be a string.',
            'subjects.*.*.code.max' => 'Subject code cannot exceed 100 characters.',
