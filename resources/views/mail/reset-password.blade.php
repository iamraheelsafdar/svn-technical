...
<div class="email-container">
    ...
    <div class="email-body">
        <p>Hi {{$user->name}},</p>
        <p>We received a request to reset your password for your RGTMI account. If you made this request, you can reset your password by clicking the button below:</p>
        ...
        <p>If you have any questions, feel free to contact our support team at <a href="mailto:support@rgtmi.com">support@rgtmi.com</a>.</p>
        <p>Thank you,</p>
