...
<div class="email-container">
    ...
    <div class="email-body">
        ...
        <p>Welcome to RGTMI! 🚀 We’re excited to have you on board. Your account has been successfully created, and you’re just one step away from accessing all our features.</p>
        ...
        <p>Login Here:<br><a class="reset-button" href="{{env('LIVE_URL')}}">RGTMI Login</a></p>
        <h4>What’s Next?</h4>
        <p>
        ...
        <p>If you didn’t sign up for this account or need assistance, please contact us at <a href="mailto:support@rgtmi.com">support@rgtmi.com</a>.<br>
        🔹 Follow us for the latest updates:<br>
        📌 LinkedIn | 📌 Twitter | 📌 Facebook</p>
        <p>Thank you for joining us! We’re here to support you every step of the way.</p>
        <p><b>Best regards,</b></p>
        <p><b>The RGTMI Team</b></p>
        <p>🌐 <a href="https://software.rgtmi.com/">https://software.rgtmi.com/</a></p>
    </div>
    <div class="email-footer">
        &copy; {{date('Y')}} RGTMI. All rights reserved.
    </div>
</div>
</body>
</html>
