...
@section('content')
    <div class="pb-4">
        <form class="row" action="{{ route('addCourse') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="col-6 col-md-6 col-lg-3 mb-3">
                ...
                <input type="number" class="form-control" id="duration" name="duration" min="1"
                        value="{{ old('duration')}}"
                       placeholder="Select course type first" disabled required>
            </div>
            ...
            <div class="col-6 col-md-6 col-lg-3 mb-3">
                ...
                <select id="stream_name" name="stream_name" class="form-select" aria-label="Default select example">
                    <option value="{{old('stream_name')}}">Select Stream</option>
