...
<h2 style="position: relative; top:470px; margin-left: 33px; display: block; font-size: 20px;font-weight: bold;color: #000000;">{{$data['institute_name']}}</h2>

<p style="position: relative; top:580px; margin-left: 33px; padding-right: 20px;display: block; font-weight: bold;color: #000000;">This
...
<h4 style="position: relative; top:714px; margin-left: 103px; display: block; font-weight: bold;color: #000000;">{{$data['footer_date']}}</h4>
