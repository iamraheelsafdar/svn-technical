...
<h2 style="position: relative; top:290px; margin-left: 20px; text-align: center; display: block; font-weight: bold;color: #6e6c6c;font-size: 13px; margin-bottom: -30px">{{ $student['name'] }}</h2>
...
<div style="position: relative; top:250px; margin-left: 30px; margin-right: 30px; margin-bottom: -300px">
...
<h4 style="position: relative; top:748px; margin-left: 120px; display: block; font-weight: bold;color: #6e6c6c; text-transform: uppercase; font-size: 13px">{{$data['footer_date']}}</h4>
